  ...
  <div class="home-container">
    <div class="content">
      <div class="text">
        ...
        <p class="description">
          AI-VUE,一个基于人工智能技术的在线咨询平台，旨在为用户提供温暖、贴心的咨询服务。在这里，您可以与我们的智能机器人进行对话，分享您的想法和感受，获得专业的建议和支持。
        </p>
        <div class="hero-actions">
          <el-button size="large" @click="router.push('/consultation')">开始倾诉，获得陪伴</el-button>
          <el-button size="large" @click="router.push('/emotion-diary')" style="border-color: #fff;"
            color="transparent">记录心情，释放情感</el-button>
        </div>
      </div>
      <div class="robot">
        <el-image :src="iconUrl" style="height: 150px; width: 150px" />
      </div>
    </div>
  </div>
</template>
